...
public class HostDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commentModels.add(new CommentModel(R.drawable.user2, "Phong Long", "23/2/2018", 5, " Ngon quá !!!"));
        commentModels.add(new CommentModel(R.drawable.profile_360x360, "Người chuộc tội", "23/2/2018", 3, "Cũng hay đấy!"));
